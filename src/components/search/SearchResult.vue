<template>
  <article class="search-result" v-if="ispaper">
  ...
  <div class="search-result__heading">
   ...
   <div class="search-result__subhead">
      <div id="calender">
...
export default {
  ...
  computed:{
    ...
    isaffiliation(){
      return this.$props.type == 'affiliation'
    }
  },
  methods: {
  ...
  mounted() {
    ...
    if(this.$props.type == 'paper'){
      ...
      this.result.pubs.raw.forEach(this.addToAuthorPubs);
